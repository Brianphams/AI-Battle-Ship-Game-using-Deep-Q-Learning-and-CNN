...
class DQNNetwork:
    def __init__(self, board_width, board_height, num_ships, model_file=None):
        ...
        self.epsilon = 1.0  # Bắt đầu với 100% khám phá (exploration)
        self.epsilon_min = 0.01  # Giá trị epsilon nhỏ nhất
        self.epsilon_decay = 0.995  # Hệ số giảm epsilon qua mỗi episode
    ...
    # Phương thức giảm epsilon sau mỗi episode
